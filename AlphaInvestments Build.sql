...
(	card_id			INT CONSTRAINT pk_cardlist_card_id	PRIMARY KEY,
	...
	--set_release_date date CONSTRAINT fk_Set_Release_Date FOREIGN KEY (set_name) REFERENCES Set_Release(set_name)
...
(	event_id		int CONSTRAINT event_id_key PRIMARY KEY,
	...
	state			NVARCHAR(30),
	city			NVARCHAR(30),
	corp_id			INT CONSTRAINT fk_corp_id FOREIGN KEY
		REFERENCES Corporation_List(corp_id)
);
